...
<template>
  <label
    class="border-light-gray has-checked:border-purplish-blue has-checked:bg-alabaster flex gap-3 rounded-sm border px-4 py-4"
  >
    <input v-model="model" type="radio" class="hidden" :value="plan" />
